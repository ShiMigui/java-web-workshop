...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, Instant.parse("2024-03-06T15:32:00Z"), "Buenos días Colômbia!","Tenho o prazer de contar que vim a Colômbia! Este país maravilhoso", u3);
		Post p4 = new Post(null, Instant.parse("2024-03-08T12:45:00Z"), "Experiências no país da Colômbia","Estou impressionado com a cultura e a hospitalidade colombianas. Uma experiência incrível até agora!",
				u3);
		...
		p1.addComment(new CommentDTO(Instant.parse("2024-03-08T12:51:00Z"), u2, "Que legal mano!"));
		p1.addComment(new CommentDTO(Instant.parse("2024-03-09T10:32:00Z"), u1, "Que sonho, sair do Brasil kkkk"));
